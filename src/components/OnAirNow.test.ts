...
describe("OnAirNow", () => {
  ...
  it("replaces current results on a one-minute refresh and handles failures", () => {
    expect(onAirNowSource).toContain("refreshIntervalMilliseconds = 60_000");
    ...
    expect(onAirNowSource).toContain("official POTA app");
  });
